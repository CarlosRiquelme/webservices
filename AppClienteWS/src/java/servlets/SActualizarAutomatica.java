 ...
 * @author toshiba
 */
@WebServlet(name = "SActualizarAutomatica", urlPatterns = {"/SActualizarAutomatica"})
public class SActualizarAutomatica extends HttpServlet {
